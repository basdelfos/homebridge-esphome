...
class FanAccessory extends BaseAccessory {
  constructor(platform, homebridgeAccessory, deviceConfig) {
    ...
    this.espHomeWebApi.stateEvent((obj) => {
      ...
      if (obj.id === `fan-${this.deviceConfig.id}`) {
        ...
        this.service.getCharacteristic(Characteristic.RotationSpeed).updateValue(this._convertSpeedToPercentage(obj.speed));
        this.log.debug('Characteristic.RotationSpeed changed to', obj.speed, this._convertSpeedToPercentage(obj.speed));
      }
    });
